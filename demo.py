...
show_samples(x, path='results/demo/01_pc_samples.png')
...
x_ode, nfe = sampling_fn(score_model)
show_samples(x_ode, path='results/demo/02_ode_samples.png')
...
with open('results/demo/03_bpds.json', 'w') as f:
    json.dump([x.item() for x in bpds], f)
...
plt.savefig('04_original_and_recons_images.png')
